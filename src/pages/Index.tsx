  ...
  return (
    <>
      ...
      <AuroraBackground className="relative overflow-hidden">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-8 left-8 bg-custom-dark-gray/80 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-custom-medium-gray/30 z-10">
                ...
                <div className="absolute top-8 right-8 bg-custom-dark-gray/80 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-custom-medium-gray/30 z-10">
        ...
        {/* Medical Professional Image - Fixed to bottom */}
        <div className="absolute right-0 bottom-0 w-1/2 h-full">
          <img 
            src="/lovable-uploads/ac2150ff-2063-47c8-bf04-1d6259354c81.png" 
      ...
      <section className="py-20 bg-custom-dark-gray text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" className="bg-custom-gold hover:bg-custom-gold/90 text-black" asChild>
            <Link to="/agendamento">Agendar agora</Link>
          </Button>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-12">
            <Button variant="outline" className="border-custom-gold text-custom-gold hover:bg-custom-gold hover:text-black" asChild>
      ...
      <section className="py-20 bg-custom-dark-gray">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-custom-medium-gray p-6 rounded-lg shadow-sm text-center border border-custom-light-gray/20">
              <div className="h-20 w-20 bg-custom-gold/10 rounded-full flex items-center justify-center mx-auto mb-4">
